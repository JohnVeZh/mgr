package cn.sparke.modules.system.role.controller;

import cn.sparke.core.common.constants.Const;
import cn.sparke.core.common.constants.cache.Cache;
import cn.sparke.core.common.constants.dictmap.RoleDict;
...
import cn.sparke.core.modules.mgrCache.CacheKit;
...
import cn.sparke.modules.system.role.service.RoleService;
...
public class RoleController extends BaseController {
    ...
    @ResponseBody
    public Tip add(@Validated Role role) {
        role.preInsert();
    ...
    @Permission(Const.ADMIN_NAME)
    @ResponseBody
    public Tip edit(@Validated Role role) {
        role.preUpdate();
    ...
    public List<ZTreeNode> roleTreeListByUserId(@PathVariable String userId) {
        User theUser = this.userMapper.getById(userId);
