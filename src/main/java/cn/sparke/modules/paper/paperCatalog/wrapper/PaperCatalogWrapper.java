package cn.sparke.modules.paper.paperCatalog.wrapper;
 ...
 * @date 2017/7/19
 */
public class PaperCatalogWrapper extends BaseControllerWrapper {
    public PaperCatalogWrapper(Object obj) {
        super(obj);
    }

    @Override
    protected void wrapperDict(List<WrapperBean> wrapperList) {
        wrapperList.add(new WrapperBean("type","paper_catalog_type","typeName"));
