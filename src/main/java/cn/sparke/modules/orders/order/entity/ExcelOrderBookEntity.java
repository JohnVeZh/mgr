 ...
 */
public class ExcelOrderBookEntity {
    ...
    @ExcelField(title = "订单金额", order = 5)
    private BigDecimal orderPrice;
    @ExcelField(title = "实付金额", order = 6)
    private BigDecimal payPrice;
    @ExcelField(title = "订单总额", order = 7)
    private BigDecimal totalProductPrice;
    @ExcelField(title = "买家昵称", order = 8)
    private String nickname;
    @ExcelField(title = "收货人", order = 9)
    private String receiver;
    @ExcelField(title = "收货电话", order = 10)
    private String receiveMobile;
    @ExcelField(title = "用户帐号", order = 11)
    private String phone;
    @ExcelField(title = "收货邮编", order = 12)
    private String zipcode;
    @ExcelField(title = "省", order = 13)
    private String provinceName;
    @ExcelField(title = "市", order = 14)
    private String cityName;
    @ExcelField(title = "区", order = 15)
    private String countyName;
    @ExcelField(title = "详细地址", order = 16)
    private String receiveAddress;
    @ExcelField(title = "买家留言", order = 17)
    private String clientRemarks = "未留言";
    @ExcelField(title = "商家留言", order = 18)
    private String shopRemarks;
    @ExcelField(title = "订单运费", order = 19)
    private BigDecimal postagePrice;
    @ExcelField(title = "下单时间", order = 20)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private String createDate;
    @ExcelField(title = "订单状态", order = 21)
    private String orderStatus;
    @ExcelField(title = "支付类型", order = 22)
